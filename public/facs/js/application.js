...
(function(){
    $(document).ready(function(e){
        ...
        if(demoType === "play"){
          demoMessage = function() {
            document.querySelector("#select-play").classList.remove("hidden");
            document.querySelector("#select-parent").classList.remove("hidden");
          };
        }
        else if(demoType === "watch"){
          demoMessage = function() {
            document.querySelector("#select-watch").classList.remove("hidden");
            document.querySelector("#select-parent").classList.remove("hidden");
          };
          ...
          demoMessage = function() {
            document.querySelector("#select-present").classList.remove("hidden");
            document.querySelector("#select-parent").classList.remove("hidden");
          };
        }
        else{
